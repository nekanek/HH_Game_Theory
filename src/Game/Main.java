...
//        myGame.play();
        ...
        startGame("Ignorants", 0, 0, 0,  10, 0, 0,  0, 0, 0, 0);
        ...
        startGame("Pure Def", 10, 0, 0,  0, 0, 0,  0, 0, 0, 0);
        startGame("Pure Coop", 0, 10, 0,  0, 0, 0,  0, 0, 0, 0);
        startGame("Pure Tit", 0, 0, 10,  0, 0, 0,  0, 0, 0, 0);
        startGame("Pure Rand", 0, 0, 0,  10, 0, 0,  0, 0, 0, 0);
        startGame("Pure Tit forgiving", 0, 0, 0,  0, 10, 0,  0, 0, 0, 0);
        startGame("Pure Less", 0, 0, 0,  0, 0, 10,  0, 0, 0, 0);
        startGame("Pure avg85", 0, 0, 0,  0, 0, 0,  10, 0, 0, 0);
        startGame("Pure long mem", 0, 0, 0,  0, 0, 0,  0, 10, 0, 0);
        startGame("Pure comparators", 0, 0, 0,  0, 0, 0,  0, 0, 10, 0);
        startGame("Pure avg50", 0, 0, 0,  0, 0, 0,  0, 0, 0, 10);
        
        startGame("coops and long mem", 0, 8, 0,  0, 0, 0,  0, 2, 0, 0);
        startGame("comps and less and long mem", 0, 0, 0,  0, 0, 3,  0, 4, 3, 0);
    }
    
    private static void startGame(String label, int def, int coop, int tit, int ran, int titF, int less, int avg85, int lm, int cmp, int avg50) {
    ...
    private static ArrayList<Player> createPlayers (int def, int coop, int tit, int ran, int titF, int less, int avg85, int lm, int cmp, int avg50) {
        ArrayList<Player> players = new ArrayList<>();
        while (def > 0 || coop > 0 || tit > 0 || ran > 0 ||titF > 0 || less > 0 || avg85 > 0 || lm > 0 || cmp > 0 || avg50 > 0) {
